...
public class Keys {
    ...
    public static final double     HEADING_THRESHOLD       = 3;      // As tight as we can make it with an integer gyro
    ...
    */
    ...
    public static final String capBallLeft = "cap_left";
    public static final String capBallRight = "cap_right";
